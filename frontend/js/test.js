...
class OrderRepository {
  order(contact) {
    // Méthode permettant d'envoyer les données au serveur avec Post
  ...
  getOrderId() {
    // Méthode permettant de récupérer la valeur de orderIsConfirmed (ID et montant de la commande)
